...
# SECURITY
# =======================
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-aam2%gli4w71v+)+^t^u94wl$!r1=+)@dvn@lr3x53ycr)xlpv")

DEBUG = os.getenv("DEBUG", "False") == "True"

# Automatically detect Railway domain
RAILWAY_DOMAIN = os.getenv("RAILWAY_PUBLIC_DOMAIN")

if RAILWAY_DOMAIN:
    ALLOWED_HOSTS = [RAILWAY_DOMAIN, "127.0.0.1", "localhost"]
else:
    ALLOWED_HOSTS = ["*"]  # fallback for development + deployment
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR,                # allows index.html in project root
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://postgres:LkhopoZHnSwsbViduiNxJnYkhbQPhLXS@gondola.proxy.rlwy.net:20816/railway",
        conn_max_age=600,
        ssl_require=True
    )
}
